                ...
                if ('loginType' in session_request && session_request['loginType'] == null) {
                        ...
                        if (create_session['stat'] == 'Ok') {
                                ...
                                ws.on('message', async function incoming(data) {
                                        ...
                                        console.log("-------INDICES depth Data---------", jsonData);
                                        if ((jsonData.ts == undefined) && ((jsonData.t == undefined) || (jsonData.t == "ck")) && (jsonData.e == undefined)) {
                                                console.log("-");
                                        } else {
                                        ...
                                        if ('s' in jsonData && jsonData['s'] == 'OK') {
                                                ...
                                                let findExchange = await ExchangeToken.find({ sheet: "INDICES" });
